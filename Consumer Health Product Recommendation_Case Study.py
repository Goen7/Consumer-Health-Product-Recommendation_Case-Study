...
fig, ax = plt.subplots(figsize=(7, 5),tight_layout())
PartialDependenceDisplay.from_estimator(best_rf, X_test, ['user_avg_health_interest'], ax=ax)
ax.set_title("Partial Dependence: user_avg_health_interest", fontsize=14, fontweight='bold')
ax.set_ylabel("Partial Dependence", fontsize=12)
ax.set_xlabel("user_avg_health_interest", fontsize=12)
...
fig, ax = plt.subplots(figsize=(7, 5), tight_layout()) 
PartialDependenceDisplay.from_estimator(best_rf, X_test, ['days_since_last_user_interaction'], ax=ax)
ax.set_title("Partial Dependence: days_since_last_user_interaction", fontsize=14, fontweight='bold')
ax.set_ylabel("Partial Dependence", fontsize=12)
ax.set_xlabel("days_since_last_user_interaction", fontsize=12)
ax.grid(True, linestyle='--', alpha=0.7)
plt.tight_layout()
plt.show() 
